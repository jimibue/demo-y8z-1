...
export default function PrivacyPolicy() {
  ...
  <Header />
    <div style={{padding:'20px 100px'}}>
      ...
      <p  className="mt-4 text-lg tracking-tight ">Last updated: August 19, 2022</p>
      ...
      <h1  className="font-display text-3xl tracking-tight text-white sm:text-4xl">Interpretation and Definitions</h1>
      <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">Interpretation</h2>
      <p  className="mt-4 text-lg tracking-tight ">
      ...
      <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">Definitions</h2>
      <p  className="mt-4 text-lg tracking-tight ">For the purposes of this Privacy Policy:</p>
      <ul>
        <li>
          <p  className="mt-4 text-lg tracking-tight ">
        ...
        <li>
          <p  className="mt-4 text-lg tracking-tight ">
            ...
            this Agreement) refers to Y8Z, 240 West Paxton Ave, Salt Lake City,
            UT.
          </p>
        </li>
        <li>
      ...
      <h1  className="font-display text-3xl tracking-tight text-white sm:text-4xl">Collecting and Using Your Personal Data</h1>
      <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">Types of Data Collected</h2>
      <h3>Personal Data</h3>
      <p  className="mt-4 text-lg tracking-tight ">
      ...
      <ul>
        <li>
          <p  className="mt-4 text-lg tracking-tight ">Email address</p>
        </li>
        <li>
          <p  className="mt-4 text-lg tracking-tight ">Usage Data</p>
        </li>
      </ul>
      <h3>Usage Data</h3>
      ...
      <ul>
        <li>
          ...
          <p  className="mt-4 text-lg tracking-tight ">Type: Session Cookies</p>
          <p  className="mt-4 text-lg tracking-tight ">Administered by: Us</p>
          <p  className="mt-4 text-lg tracking-tight ">
        ...
        <li>
          ...
          <p  className="mt-4 text-lg tracking-tight ">Type: Persistent Cookies</p>
          <p  className="mt-4 text-lg tracking-tight ">Administered by: Us</p>
          <p  className="mt-4 text-lg tracking-tight ">
      ...
      <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">Use of Your Personal Data</h2>
      <p  className="mt-4 text-lg tracking-tight ">The Company may use Personal Data for the following purposes:</p>
      <ul>
        <li>
          <p  className="mt-4 text-lg tracking-tight ">
      ...
      <p  className="mt-4 text-lg tracking-tight ">We may share Your personal information in the following situations:</p>
      <ul>
        <li>
      ...
      <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">Retention of Your Personal Data</h2>
      <p  className="mt-4 text-lg tracking-tight ">
      ...
      <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">Disclosure of Your Personal Data</h2>
      ...
      <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">Security of Your Personal Data</h2>
      <p  className="mt-4 text-lg tracking-tight ">
      ...
      <h1  className="font-display text-3xl tracking-tight text-white sm:text-4xl">Changes to this Privacy Policy</h1>
      <p  className="mt-4 text-lg tracking-tight ">
      ...
      <h1  className="font-display text-3xl tracking-tight text-white sm:text-4xl">Contact Us</h1>
      <p  className="mt-4 text-lg tracking-tight ">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li>By email: y8z.studios@gmail.com</li>
      </ul>
    </div>
    <Footer />
    </>
