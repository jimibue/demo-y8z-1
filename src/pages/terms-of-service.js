...
export default function TermsOfService() {
  return (
    <>
      <Header />
      <div style={{ padding: '0 90px' }} clasName="ml-30 mr-30">
        <h1 className="mb-10 mt-10 font-display text-3xl tracking-tight text-slate-900 dark:text-white">
          TERMS OF SERVICE
        </h1>
        <h1 className="mb-10 mt-10 font-display text-3xl tracking-tight text-slate-900 dark:text-white">
       ...
       &quot;Content&quot;) and the trademarks, service marks, and logos contained
        ...
        thereof).
        <h1 className="mb-10 mt-10 mb-10 mt-10 font-display text-3xl tracking-tight text-slate-900 dark:text-white">
       ...
       &quot;spyware&quot; or&quot;passive collection mechanisms&quot; or&quot;pcms&quot;). Interfere with,
        ...
        shall not:
        <br /> (1) except as permitted by applicable law, decompile, reverse
        ...
        any website or to send any unsolicited commercial e-mail; or (9) use any
        ...
        Y8Z LLC and yourself irrevocably consent that the courts of shall have
        ...
        in Salt Lake, Utah. Except as otherwise provided herein, the Parties may
        ...
        courts located in Salt Lake, Utah, and the Parties hereby consent to,
        ...
        PAID, IF ANY, BY YOU TO US DURING THE ZERO (0) MONTH PERIOD PRIOR TO ANY
        CAUSE OF ACTION ARISING OR $0.00 USD. CERTAIN US STATE LAWS AND
        ...
        information regarding use of the Site, please contact us at: Y8Z LLC
        y8z.studios@gmail.com
      </div>
      <Footer />
    </>
  )
