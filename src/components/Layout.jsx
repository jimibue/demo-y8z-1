...
import { fullstackNav } from './layoutNavs/fullstack-nav'
...
export function Layout({ children, title, tableOfContents }) {
    ...
    return (
      <>
        ...
        <div
          ...
          role="alert"
        >
          <span className="font-medium">Note:</span> We constantly update and add new material to our prep work, if it has been a while since you have been here check around for new content
        </div>
        <HeroPrep />
  ...
  function getNavigation(path) {
    ...
    if (path.includes('fullstack')) return fullstackNav
    ...
    if (path.includes('ts')) return introToTSNav
